...
namespace WooNet
{
    public class WSClient : IDisposable, IWSClient
    {
        TcpClient clientProvider = null;
        ...
        public WSClient(int bufferSize = 4096, int blocks = 8)
        {
            clientProvider = new TcpClient(bufferSize, blocks);
        ...
        public static WSClient CreateProvider(int bufferSize = 4096, int blocks = 8)
        {
            return new WSClient(bufferSize, blocks);
        }
        ...
        public bool Connect(string wsUrl)
        {
            ...
            isOk = clientProvider.Send(new Segment(encoding.GetBytes(req)));
        ...
        public bool Send(Segment data, bool waiting = true)
        {
            if (IsConnected == false) return false;
        ...
        public void SendPong(Segment buf)
        {
