...
namespace WooNet
{
    ...
    public class UdpServer : UdpSocket, IDisposable, IUdpServer
    {
        #region variable
        ...
        /// 构造方法
        /// </summary>
        public UdpServer(int maxNumberOfConnections, int bufferSizeByConnection, bool Broadcast = false)
        ...
        public bool Send(Segment dataSegment, IPEndPoint remoteEP, bool waiting = true)
        {
            return socketSend.Send(dataSegment, remoteEP, waiting);
        }

        public int SendSync(IPEndPoint remoteEP, Segment dataSegment)
        {
