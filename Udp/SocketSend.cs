...
namespace WooNet
{
    ...
    internal class SocketSend : UdpSocket,IDisposable
    {
            ...
            : base(blockSize)
        {
            ...
            sendTokenManager = new ArgPool(maxCountClient);
            sendBufferManager = new BytePool(maxCountClient, blockSize);
        ...
        public bool Send(Segment dataSegment, IPEndPoint remoteEP, bool waiting)
        {
            try
            {
        ...
        /// <param name="remoteEP"></param>
        /// <returns></returns>
        public int SendSync(Segment dataSegment, IPEndPoint remoteEP)
        {
