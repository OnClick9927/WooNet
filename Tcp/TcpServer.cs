...
namespace WooNet
{
    ...
    public class TcpServer : TcpSocket, IDisposable, ITcpServer
    {
        #region variable
        ...
        private ArgPool acceptTokenManager = null;
        private BytePool recvBufferManager = null;
        private BytePool sendBufferManager = null;
        ...
        public TcpServer(int maxConnections = 32, int chunkBufferSize = 4096)
            : base(chunkBufferSize)
        {
            ...
            recvBufferManager = new BytePool(maxConnections + offsetNumber, chunkBufferSize);
            acceptTokenManager = new ArgPool(maxConnections + offsetNumber);

            sendTokenManager = new ArgPool(maxConnections + offsetNumber);
            sendBufferManager = new BytePool(maxConnections + offsetNumber, chunkBufferSize);
        }
