...
namespace WooNet
{
    ...
    public class WSServer : IDisposable, IWSServer
    {
        private Encoding encoding = Encoding.UTF8;
        TcpServer serverProvider = null;
        ...
        public WSServer(int maxConnections = 32, int bufferSize = 4096)
        {
            ConnectionPool = new List<ConnectionInfo>(maxConnections);

            serverProvider = new TcpServer(maxConnections, bufferSize);
