...
namespace WooNet
{
    public class UdpClient : UdpSocket, IDisposable, IUdpClient
    {
        #region 定义变量
        ...
        /// 构造方法
        /// </summary>
        public UdpClient(int bufferSizeByConnection, int maxNumberOfConnections)
        ...
        /// <param name="recAct"></param>
        /// <param name="recBufferSize"></param>
        public void ReceiveSync(Segment receiveSegment, Action<Segment> receiveAction)
        {
            int cnt = 0;
            do
            {
        ...
        {
            sendTokenManager = new ArgPool(maxNumberOfConnections);
            sendBufferManager = new BytePool(maxNumberOfConnections, bufferSizeByConnection);
